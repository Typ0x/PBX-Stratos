...
| `s1.t9` | Pick a Claude personality (Default / Crypto Bro / Drill Sergeant / Surf Bro / Quant Professor / Hacker) — matching theme auto-applies to the dashboard | `personality_id` + `theme_id` saved in profile, `bear-den/dashboards/active-theme.css` updated |
