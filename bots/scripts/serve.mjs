...
//
// `npm run server` used to be `PBX_ALLOW_AUTOGEN=1 tsx src/server/index.ts`
...
//
// Only PBX_ALLOW_AUTOGEN is set here — same as the old script. It does
...
// Override autogen by exporting PBX_ALLOW_AUTOGEN=0 before running.
process.env.PBX_ALLOW_AUTOGEN ??= '1';
